...
## General FAQ
### Logs
When it comes to troubleshooting issues in the Gluu Server--from service hiccups to outages--your [server logs](./logmanagment.md) are the best place to gather relevant information.
